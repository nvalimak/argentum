 ...
 */
void extract(InputReader &ir, direction_t direction, PointerTree &tree, TreeController &tc, Configuration const &config, string const &dotprefix, TreeController &predictor_tc, PointerTree &predictor_tree, bool newick)
{
    unsigned prev_hsize = 0;
    unsigned prev_reused = 0;
    unsigned prev_stashed = 0;
