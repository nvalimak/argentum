...
int main(int argc, char ** argv)
{
    ...
    TreeController forward_tc(forward_tree, debug, dotfile);
    ...
    TreeController backward_tc(backward_tree, debug, dotfile.empty() ? "" : "backward");
    prev_hsize = 0;
    prev_reused = 0;
    prev_stashed = 0;
    prev_relocates = 0;
    ...
    TreeController final_tc(final_tree, debug, dotfile.empty() ? "" : "final");
    prev_hsize = 0;
    prev_reused = 0;
    prev_stashed = 0;
    prev_relocates = 0;
